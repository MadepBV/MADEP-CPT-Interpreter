...
<script lang="ts">
	...
	const canonicalUrl = 'https://cpt.madep.be/docs/full';
	...
	const nuDefaultRows: Record<string, string>[] = [
	...
	const sections: DocSection[] = [
		{
			...
			intro:
				'This page documents the technical logic of the CPT interpreter from raw CPT file import through Stage 6 engineering use. It is written as a theory-and-implementation note: formulas, classifications, parameter routes, engineering assumptions, and the principal references behind the current application.',
			subsections: [
				{
		...
		},
		{
			...
			subsections: [
				...
				},
				{
					...
					table: {
						...
						note:
							'Values are proposal defaults for the soil-type → ν′ → β → E_def cascade; the engineer overrides ν′ per layer in Stage 4, and any Stage 3 soil-type selection re-proposes the table value. Full citations in the References section.',
						collapsible: true,
			...
			references: ['SB260', 'CUR 2003-7', 'Schanz, Vermeer & Bonnier (1999)', 'OVAM / I-RA-11461 (2002)', 'De Smedt / VUB (2005)', 'PLAXIS 2D Material Models Manual (2025.1)', 'Bentley KB0109063', 'Bentley KB0109071', 'Bentley KB0043470', 'Bentley KB0108936', 'ČSN 73 1001:1987', 'SCIA Engineer 25.0 Online Help (Soilin)', 'SCIA Topic Training — Foundations (2024)', 'GEO5 Online Help — Oedometric Modulus', 'EN 1997-2:2007', 'prEN 1997-2 (2021 draft)', 'Buildwise (2022)', 'Kulhawy & Mayne (1990)', 'O’Kelly (2017)', 'AASHTO LRFD (2020)', 'Bowles (1996)']
		},
		{
			id: 'stage5',
...
<div class="docs-page">
	...
	<header class="hero">
		<div class="hero__inner">
			<p class="hero__eyebrow">Technical specification</p>
			<h1>Long-form technical specification.</h1>
			<p class="hero__lead">
				A technical implementation note for the CPT app workflow: GEF, Excel, and CSV loading,
			...
			<div class="hero__actions">
				...
				<a class="btn btn--outline-dark" href="#stage1">Open the specification</a>
			</div>
			<div class="hero__trust">
				<span>Full CPT workflow</span>
				<span>Long-form reference</span>
			</div>
		</div>
	</header>
	...
	<div class="docs-shell">
		<aside class="docs-nav" aria-label="On this page">
			...
			<a href="/docs/full" aria-current="page">Specification</a>

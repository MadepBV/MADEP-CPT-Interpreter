		...
		<main class="docs-content">
			...
			<section id="solverlink" class="doc-card">
				...
				<p>
					...
					width, converts the geometric inputs to a 1000 mm reference width, derives the effective
				...
				<div class="equations">
					...
					<div class="formula">b<sub>w</sub> = 1000 mm    (reference strip width)</div>
				...
				<ul class="notes">
					...
					<li>The section width is always one meter of strip, so A<sub>s</sub> is reported in mm² per meter width.</li>
				</ul>
			</section>

			<section id="kinematics" class="doc-card">
				<p class="section-label">Kinematics and constitutive laws</p>
				<h2>3. Plane sections, concrete law, and steel law</h2>
				<p>
			...
			<section id="block" class="doc-card">
				...
				<h2>4. Equivalent rectangular block and its λ, η factors</h2>
				<p>
			...
			<section id="route" class="doc-card">
				...
				<h2>5. Dimensionless moment μ and mechanical ratio ω</h2>
				<p>
			...
			<section id="ductility" class="doc-card">
				...
				<h2>6. Limiting neutral-axis depth and the case for compression steel</h2>
				<p>
			...
			<section id="minmax" class="doc-card">
				...
				<h2>7. Minimum and maximum reinforcement area</h2>
				<p>
			...
			<section id="shear" class="doc-card">
				...
				<h2>8. Shear capacity without stirrups (V<sub>Rd,c</sub>)</h2>
				<p>
			...
			<section id="materials" class="doc-card">
				...
				<h2>9. Material factors, structural class, and the implemented EC2 cover route</h2>
				<p>
			...
			<section id="spacing" class="doc-card">
				...
				<h2>10. From required steel area to bars per meter or bar spacing</h2>
				<p>
				...
				<div class="symbols">
					...
					<dl class="symbols__list">
						...
						<div class="symbols__row">
							...
							<dd>Area actually provided by the chosen diameter-and-spacing arrangement [mm²/m].</dd>
						</div>
						<div class="symbols__row">
							<dt>s</dt>
			...
			<section id="outputs" class="doc-card">
				...
				<h2>11. Reported quantities and boundaries of validity</h2>
				<p>

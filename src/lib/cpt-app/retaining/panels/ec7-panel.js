...
export function ec7Panel(rw) {
  ...
  const body = `
    ...
    <div class="st6-rw-card-title" style="margin-top:10px">Design excavation</div>
    ...
    <div class="st6-rw-card-title" style="margin-top:10px">Branch details</div>
    ...
    <div class="st6-rw-card-title" style="margin-top:10px">Earth-pressure assumptions</div>
    ...
    <div class="st6-rw-card-title" style="margin-top:10px">Strength sensitivity (e.g. SB260 γ<sub>φ</sub> = 1.30)</div>
    ${checkRow('Add a sensitivity strength set', 'settings.materialOverride.enabled', !!mo.enabled)}
    ${mo.enabled ? `<div class="st6-rw-soilgrid">${numberRow('γ<sub>φ</sub>', 'settings.materialOverride.gPhi', mo.gPhi, { step: 0.05, min: 1 })}${numberRow('γ<sub>c</sub>', 'settings.materialOverride.gC', mo.gC, { step: 0.05, min: 1 })}${numberRow('γ<sub>cu</sub>', 'settings.materialOverride.gCu', mo.gCu, { step: 0.05, min: 1 })}</div>

...
// @ts-nocheck
//
// TEMPORARY re-export — the module moved to src/lib/cpt-app/pile/canvas.js (refactor step 7,
...
// integration-r:…legacy-controller.js`, which still imports './stage6-pile-canvas') keep resolving
// while PR 12b is not yet on that ref. Delete it (and stage6-pile.js) once integration-r contains
// the pile package; scripts/verify_pile.mjs does not need it (it materialises the base's own copies).
export * from './pile/canvas.js';

...
em++ \
  ...
  -s EXPORTED_FUNCTIONS='["_malloc","_free","_madepRunDeformationAnalysis","_madepRunMcPlasticMaterialPoint","_madepRunHsMaterialPoint","_madepGetLastErrorMessage","_madepFreeBuffer"]' \
  -I "$SRC_DIR" \

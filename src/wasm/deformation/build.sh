...
em++ \
  ...
  -s EXPORTED_FUNCTIONS='["_malloc","_free","_madepRunDeformationAnalysis","_madepRunMcPlasticMaterialPoint","_madepRunHsMaterialPoint","_madepGetLastErrorMessage","_madepGetLastNewtonStepIterationsJson","_madepFreeBuffer"]' \
  -I "$SRC_DIR" \
